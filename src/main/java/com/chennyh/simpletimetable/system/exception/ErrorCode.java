...
public enum ErrorCode {
    ...
    EMAIL_ALREADY_EXIST(1001, HttpStatus.NOT_FOUND, "邮箱已经存在"),
    NOT_FOUND(1002, HttpStatus.NOT_FOUND, "未找到指定资源"),
    USER_ID_NOT_FOUND(1002, HttpStatus.NOT_FOUND, "未找到用户ID"),
    COURSE_ID_NOT_FOUND(1002, HttpStatus.NOT_FOUND, "未找到课程ID"),
